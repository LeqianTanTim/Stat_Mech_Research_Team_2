...
# Combination rule: return sigma, epsilon
def combinational_rule(sigma_1, sigma_2, epsilon_1, epsilon_2):
...
def compute_forces(particle_list, accelerations, potential_energies, epsilon, box_size, dimensions, num_particles, cutoff_radius=2.5):
    #Initialization
    ...
    for i in range(num_particles - 1):
      ...
      relative_positions = positions[i] - positions[i + 1:]
