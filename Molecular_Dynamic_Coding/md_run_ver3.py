    ...
    with open('output.xyz', 'w') as file:
        ...
        for step in range(num_steps):
            ...
            if step % dump_frequency == 0:
                ...
                file.write(f"Reaction coordinate between two CH4 are {R}\n")
                for particle in particle_lst:
...
kinetic_energy_avg, potential_energy_avg, temeperatures, particle_lst, reaction_coordinates, position_per_frame = main(
